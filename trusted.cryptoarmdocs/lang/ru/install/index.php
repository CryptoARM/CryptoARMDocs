...
$MESS['TR_CA_DOCS_MAIL_EVENT_SHARE_NAME'] =
    'КриптоАРМ Документы - уведомление о получении доступа к документу';
...
$MESS['TR_CA_DOCS_MAIL_TEMPLATE_SHARE_BODY'] =
    '#SITE_NAME#: #SHARE_FROM# поделился документом #FILE_NAME#';
...
$MESS['TR_CA_DOCS_MAIL_TEMPLATE_FORM_BODY'] =
    '#SITE_NAME#: Вы успешно заполнили и подписали форму: #FILE_NAME#';

// email completed form and send it to admin
$MESS['TR_CA_DOCS_MAIL_EVENT_FORM_TO_ADMIN_NAME'] =
    'КриптоАРМ Документы - уведомление администратора о форме';
$MESS['TR_CA_DOCS_MAIL_EVENT_FORM_TO_ADMIN_DESCRIPTION'] = "
#EMAIL# - EMail получателя сообщения
#FILE_NAME# - название документа
#FORM_USER# - автор заполненной формы
";
$MESS['TR_CA_DOCS_MAIL_TEMPLATE_FORM_TO_ADMIN_SUBJECT'] =
    '#SITE_NAME#: Форма заполнена и подписана пользователем #FORM_USER#';
$MESS['TR_CA_DOCS_MAIL_TEMPLATE_FORM_TO_ADMIN_BODY'] =
    '#SITE_NAME#: Пользователь #FORM_USER# успешно заполнил форму и подписал все документы: #FILE_NAME#';
