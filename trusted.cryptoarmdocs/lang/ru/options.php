...
$MESS['TR_CA_DOCS_DOCS_DIR_CANNOT_USE_SYSTEM_DIRECTORY'] =
    'Нельзя сохранять файлы внутри системной директории.';

$MESS['TR_CA_DOCS_LICENSE_HEADER_SETTINGS'] = 'Настройки';
$MESS['TR_CA_DOCS_LICENSE_HEADER_STATISTICS'] = 'Статистика';

$MESS['TR_CA_DOCS_LICENSE_ENABLE'] =
    'Включить предоставление пользователям одноразовых лицензий на подпись документов';
...
$MESS['TR_CA_DOCS_LICENSE_CREATE_NEW_ACCOUNT_NUMBER_ALERT2'] =
    ' успешно сформирован. В целях безопасности рекомендуем дополнительно сохранить его для возможности восстановления.';
...
$MESS['TR_CA_DOCS_LICENSE_SUBMIT_DELETE_ACCOUNT_NUMBER'] =
    'Вы уверены, что хотите изменить текущий счет? В случае утери номера счета восстановление будет невозможно.';
$MESS['TR_CA_DOCS_LICENSE_SUBMIT_ACTIVATE_JWT_TOKEN'] =
    'Вы уверены, что хотите активировать токен?';
...
$MESS['TR_CA_DOCS_EVENTS_DESCRIPTION'] =
    'Заказ с прикрепленными документами можно автоматически переводить в другой статус при совершении некоторых действий.';
...
$MESS['TR_CA_DOCS_EMAIL_DESCRIPTION'] =
...
$MESS['TR_CA_DOCS_FORM_EMAIL_HEADING'] =
    'Настройки рассылки писем с документами по формам пользователю';
...
$MESS['TR_CA_DOCS_FORM_EMAIL_DESCRIPTION'] =
    'Для удобства отправки клиентам подписанных документов модуль автоматически создает почтовое событие и привязанный к нему стандартный шаблон. Вы можете отредактировать шаблон по своему усмотрению.<br /><br />В шаблоне письма можно использовать следующие поля:<br />#EMAIL# - почтовый ящик пользователя, на который будет отправлено письмо,<br />#FILE_NAMES# - список названий документов.';

$MESS['TR_CA_DOCS_FORM_TO_ADMIN_EMAIL_HEADING'] =
    'Настройки рассылки уведомлений с документами по формам администратору';
...
$MESS['TR_CA_DOCS_FORM_TO_ADMIN_EMAIL_DESCRIPTION'] =
    'Для удобства отправки администатору оповещения о успешно заполненной формы пользователем модуль автоматически создает почтовое событие и привязанный к нему стандартный шаблон. Вы можете отредактировать шаблон по своему усмотрению.<br /><br />В шаблоне письма можно использовать следующие поля:<br />#EMAIL# - почтовый ящик пользователя, на который будет отправлено письмо,<br />#FILE_NAMES# - список названий документов,<br />#FORM_USER# - автор заполненной формы.';
