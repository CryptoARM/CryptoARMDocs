...
?>
    ...
    <form method="POST" enctype="multipart/form-data"
        ...
        <? if ($saleModule): ?>
            ...
            <tr>
                <td width="30%"
                    class="trustedcryptoarmdocs_opt_multiline_cell"> <?= Loc::getMessage("TR_CA_DOCS_EVENTS_SIGNED_BY_CLIENT") ?> </td>
                <td width="70%">
        ...
        if (file_exists(TR_CA_DOCS_LOG_FILE)) {
            ...
            <input name="download_logs" type="submit" value="<?= Loc::getMessage("TR_CA_DOCS_LOGS_DOWNLOAD") ?>"
