...
class AjaxCommand {
    ...
    static function createForm($params) {
        $res = [
            'success' => false,
            'message' => 'Unknown error in Ajax.createForm',
        ];
        ...
        Forms::newForm($params);
        $res['agreementId'] = Forms::createPDFAgreement($params);
        $res['formId'] = Forms::createPDFForm($params);
        return $res;
    }

    static function removeForm() {
        Forms::removeForm();
    }
    ...
    static function getMessageListNew($params) {
        $res = [
            'success' => false,
        ...
        if (!($args['typeOfMessage'] == 'incoming' || $args['typeOfMessage'] == 'outgoing' || $args['typeOfMessage'] == 'drafts')) {
            $res['message'] = 'Unknown type';
            $res['typeOfMessage'] = $args['typeOfMessage'];
            return $res;
        }
