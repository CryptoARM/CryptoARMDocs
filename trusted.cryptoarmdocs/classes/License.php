...
class License
{
    ...
    private static function GetAccessToken () {
        ...
        $username = Option::get(TR_CA_DOCS_MODULE_ID, "TN_USERNAME", "");
        $password = Option::get(TR_CA_DOCS_MODULE_ID, "TN_PASSWORD", "");
        $id = Option::get(TR_CA_DOCS_MODULE_ID, "TN_CLIENT_ID", "");
        $secret = Option::get(TR_CA_DOCS_MODULE_ID, "TN_CLIENT_SECRET", "");
