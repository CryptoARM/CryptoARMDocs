...
// Module directories
define(
    'TR_CA_DOCS_MODULE_DIR',
    $_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/' . TR_CA_DOCS_MODULE_ID . '/'
);
...
define(
    'TR_CA_DOCS_AJAX_CONTROLLER',
    'https://' . TR_CA_HOST . '/bitrix/components/trusted/docs/ajax.php'
);
