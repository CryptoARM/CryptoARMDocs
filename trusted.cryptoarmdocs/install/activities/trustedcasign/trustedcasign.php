...
class CBPTrustedCASign extends CBPCompositeActivity implements
    IBPEventActivity,
    ...
    public function Subscribe(IBPActivityExternalEventListener $eventHandler) {
        ...
        $arParameters['TaskButtonMessage'] = $this->IsPropertyExists('TaskButtonMessage')
            ? $this->TaskButtonMessage
            : GetMessage('BPAR_ACT_BUTTON2');
    ...
    public static function ShowTaskForm($arTask, $userId, $userName = '') {
        ...
        if (
            ...
            if ($doc->getStatus() === DOC_STATUS_BLOCKED) {
                ...
                if ($blockUser == $USER->GetID()) {
                    ...
                    echo "signButton.setAttribute('value', '" .
        ...
        $buttons =
            ...
            (strlen($arTask['PARAMETERS']['TaskButtonMessage']) > 0
    ...
    public static function PostTaskForm(
        ...
        try {
            ...
            if (
                ...
                $arRequest['INLINE_USER_STATUS'] != CBPTaskUserStatus::Ok
            ) {
