...
$MESS['BPAA_PD_STATUS_MESSAGE_HINT'] =
    'Можно использовать модификаторы #PERC# - процент, #REV# - ознакомлено человек, #TOT# - всего должно быть ознакомлено';
$MESS['BPAA_PD_TIMEOUT_DURATION'] = 'Период утверждения';
$MESS['BPAA_PD_TIMEOUT_DURATION_HINT'] =
    'Если до окончания периода документ не будет утвержден либо отвергнут, то документ будет автоматически отвергнут. Пустое значение или 0 - отсутствие периода.';
$MESS['BPAA_PD_TIME_D'] = 'дней';
$MESS['BPAA_PD_TIME_H'] = 'часов';
$MESS['BPAA_PD_TIME_M'] = 'минут';
$MESS['BPAA_PD_TIME_S'] = 'секунд';
$MESS['BPAA_PD_STATUS_MESSAGE_HINT1'] =
    'Можно использовать модификаторы #PERCENT# - процент, #VOTED# - ознакомлено человек, #TOTAL# - всего должно быть ознакомлено, #APPROVERS# - список утвердивших, #REJECTERS# - список отклонивших';
