...
if ($USER->GetFullName()) {
    $compTitle =
        Loc::getMessage('TR_CA_DOCS_COMP_DOCS_BY_USER_DOCS_BY_ORDER') . $USER->GetFullName();
} else {
...
<div id="main-document">
    <main class="document-card">
            ...
            if (!empty($allIds)) { ?>
                <div id="sweeties" class="menu">
                    ...
                    <ul id="ul_by_user">
                        ...
                        <?php if ($arParams['ALLOW_REMOVAL'] === 'Y') { ?>
                            <?php $removeAllJs = "trustedCA.remove($allIdsJs, false, trustedCA.reloadDoc)"; ?>
                        ...
                        <div class="document-item__left">
                            ...
                            <div class="document-item__text">
                                ...
                                <div class="document-text__description">
                                    <?php if ($docStatus === DOC_STATUS_BLOCKED) {
                            ...
                            <div class="icon_content">
                                ...
                                <div class="icon-wrapper"
                                     title="<?= Loc::getMessage(
                                         'TR_CA_DOCS_COMP_DOCS_BY_USER_SEND_DOCS'
                                     ) ?>"
                                     onclick="<?= $emailJs ?>">
                                ...
                                if ($docAccessLevel == 'SIGN' || $docAccessLevel == 'OWNER') {
                                    ...
                                    <div class="icon-wrapper"
                                         title="<?= Loc::getMessage(
                                             'TR_CA_DOCS_COMP_DOCS_BY_USER_SIGN'
                                         ) ?>"
                                         onclick="<?= $signJs ?>">
                                        <i class="material-icons">
                                            create
                                ...
                                if ($docType === DOC_TYPE_SIGNED_FILE) { ?>
                                    <div class="icon-wrapper"
                                        title="<?= Loc::getMessage(
                                            'TR_CA_DOCS_COMP_DOCS_BY_USER_VERIFY'
                                        ) ?>"
                                        onclick="<?= $verifyJs ?>">
                                        <i class="material-icons">
                                            info
                                ...
                                <?php }
                                ?>
                                <?php $downloadJs = "trustedCA.download([$docId])"; ?>
                                <div class="icon-wrapper"
                                     title="<?= Loc::getMessage(
                                         'TR_CA_DOCS_COMP_DOCS_BY_USER_DOWNLOAD'
                                     ) ?>"
                                     onclick="<?= $downloadJs ?>">
                                    <i class="material-icons">
                                        save_alt
                                ...
                                <div class="icon-wrapper"
                                     title="<?= Loc::getMessage(
                                         'TR_CA_DOCS_COMP_DOCS_BY_USER_PROTOCOL'
                                     ) ?>"
                                     onclick="<?= $protocolJs ?>">
                                    <i class="material-icons">
                                        description
                                ...
                                <?php if ($docAccessLevel == 'OWNER') {
                                    $shareJs = "trustedCA.promptAndShare([$docId], 'SHARE_SIGN')"; ?>
                                    <div class="icon-wrapper"
                                         title="<?= Loc::getMessage(
                                             'TR_CA_DOCS_COMP_DOCS_BY_USER_SHARE'
                                         ) ?>"
                                         onclick="<?= $shareJs ?>">
                                        <i class="material-icons">
                                            share
                                    ...
                                    <?php if ($arParams['ALLOW_REMOVAL'] === 'Y') {
                                        ...
                                        <div class="icon-wrapper"
                                             title="<?= Loc::getMessage(
                                                 'TR_CA_DOCS_COMP_DOCS_BY_USER_DELETE'
                                             ) ?>"
                                             onclick="<?= $removeJs ?>">
                                            <i class="material-icons">
                                                delete
                                ...
                                <?php
                                    ...
                                    <div class="icon-wrapper"
                                         title="<?= Loc::getMessage(
                                             'TR_CA_DOCS_COMP_DOCS_BY_USER_UNSHARE'
                                         ) ?>"
                                         onclick="<?= $unshareJs ?>">
                                        <i class="material-icons">
                                            close
        ...
        <?php if ($arParams['ALLOW_ADDING'] === 'Y') {
