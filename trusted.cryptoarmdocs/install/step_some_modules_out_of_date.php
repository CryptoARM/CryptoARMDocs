...
<form action="<?= $APPLICATION->GetCurPage() ?>">
    ...
    <?=CAdminMessage::ShowMessage(Loc::getMessage("TR_CA_DOCS_SOME_MODULES_ARE_OUT_OF_DATE_AND_CANT_BE_USED") . Option::get(TR_CA_DOCS_MODULE_ID, TR_CA_DOCS_MODULES_OUT_OF_DATE) . Loc::getMessage("TR_CA_DOCS_SOME_MODULES_ARE_OUT_OF_DATE_AND_CANT_BE_USED2")) ?>
