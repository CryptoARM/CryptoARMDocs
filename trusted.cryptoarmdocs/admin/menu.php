...
if ($APPLICATION->GetGroupRight('trusted.cryptoarmdocs') >= 'R') {
    if (ModuleManager::isModuleInstalled('trusted.cryptoarmdocs')) {
        ...
        $menuItems[] = array(
            'text' => Loc::getMessage('TR_CA_DOCS_MENU_DOCUMENTS'),
        ...
        $menuItems[] = array(
            'text' => Loc::getMessage('TR_CA_DOCS_MENU_DOCUMENTS_BY_USER'),
        ...
        if (Loader::includeModule('sale')) {
            $menuItems[] = array(
                'text' => Loc::getMessage('TR_CA_DOCS_MENU_DOCUMENTS_BY_ORDER'),
        ...
        $menuItems[] = array(
            'text' => Loc::getMessage('TR_CA_DOCS_MENU_DOCUMENTS_BY_FORM'),
