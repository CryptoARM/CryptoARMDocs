...
if (($arID = $lAdmin->GroupAction()) && $POST_RIGHT == 'W') {
    ...
    switch ($_REQUEST['action']) {
        ...
        case 'send_mail':
            echo '<script>';
            echo 'window.parent.trustedCA.promptAndSendEmail(' .
                json_encode($ids) .
                ', "MAIL_EVENT_ID_TO", {}, "MAIL_TEMPLATE_ID_TO")';
            echo '</script>';
            break;
    }
}
...
$lAdmin->NavText(
    '<p>' . $rsData->GetNavPrint(Loc::getMessage('TR_CA_DOCS_NAV_TEXT_BY_USER')) . '</p>'
);
...
<form name="find_form" method="get" action="<?= $APPLICATION->GetCurPage() ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="find_user_id" size="47" value="<?= htmlspecialchars(
                $find_user_id
            ) ?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="find_user_name" size="47" value="<?= htmlspecialchars(
                $find_user_name
            ) ?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="find_user_email" size="47" value="<?= htmlspecialchars(
                $find_user_email
            ) ?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="find_doc_name" size="47" value="<?= htmlspecialchars(
                $find_doc_name
            ) ?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <?php
            $arr = array(
                'reference_id' => array('', DOC_TYPE_FILE, DOC_TYPE_SIGNED_FILE),
                'reference' => array(
                    '',
