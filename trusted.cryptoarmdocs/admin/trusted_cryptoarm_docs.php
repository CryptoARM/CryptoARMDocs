...
while ($arRes = $rsData->NavNext(true, 'f_')) {
    ...
    $docName .= "value='i' ondblclick='event.stopPropagation()' onclick='trustedCA.verify([";
    $docName .=
        $docId .
        "])' class='trca-verify-button' title='" .
        Loc::getMessage('TR_CA_DOCS_VERIFY_DOC') .
        "'/>";
    $docName .=
        "<a class='trca-tn-document-main' title='" .
...
<form name="find_form" method="get" action="<?= $APPLICATION->GetCurPage() ?>">
    ...
    <tr>
        ...
        <td><input type="text" name="find_docId" size="47" value="<?= htmlspecialchars(
            $find_docId
        ) ?>"></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" name="find_fileName" size="47" value="<?= htmlspecialchars(
            $find_fileName
        ) ?>"></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" name="find_signatures" size="47" value="<?= htmlspecialchars(
            $find_signatures
        ) ?>"></td>
    </tr>
