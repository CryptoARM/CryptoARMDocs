...
$FilterArr = array('find_iblock_elem_id', 'find_iblock_name', 'find_user_id');
...
$lAdmin->NavText(
    '<p>' . $rsData->GetNavPrint(Loc::getMessage('TR_CA_DOCS_NAV_TEXT_BY_FORM')) . '</p>'
);
...
while ($arRes = $rsData->NavNext(true, 'f_')) {
    ...
    $iBlockElementIdViewField .=
        '/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=' .
        $arRes['IBLOCK_ID'] .
        '&type=tr_ca_docs_form&ID=' .
        $iBlockElementId .
        "'";
