...
CJSCore::RegisterExt('socketio', array(
    'js' => '/bitrix/js/trusted.cryptoarmdocs/socket.io.js',
));

CJSCore::RegisterExt('trusted_cryptoarm_docs', array(
...
$APPLICATION->SetAdditionalCss(
    '/bitrix/modules/trusted.cryptoarmdocs/install/themes/.default/trusted.cryptoarmdocs.css'
);
