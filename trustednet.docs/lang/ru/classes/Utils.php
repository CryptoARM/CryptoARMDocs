...
$MESS["TN_DOCS_RESP_NO_AUTH"]="Вы не авторизованы в сервисе TrustedNet (пройдите авторизацию на вашем сайте через сервис TrustedNet)";
$MESS["TN_DOCS_RESP_NO_CONNECTION"]="Отсутствует соединение с рабочим местом сервиса TrustedNet.Sign (Установите бесплатное рабочее место сервиса TrustedNet.Sign и авторизуйтесь в нем под тем же пользователем как и на сайте)";
