<?php
$MESS["TN_DOCS_UPLOAD_TITLE"] = "Загрузка документов по пользователям";
...
$MESS["TN_DOCS_UPLOAD_INVALID_USER_ID"] = "Недопустимый ID пользователя.";
$MESS["TN_DOCS_UPLOAD_USER_ID_DOESNT_EXIST"] = "Несуществующий ID пользователя.";
...
$MESS["TN_DOCS_UPLOAD_USER_ID_NOTE"] = " Цифровой идентификатор пользователя в Битрикс.";
